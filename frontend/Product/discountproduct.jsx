...
import { useCart } from "../src/context/CartContext"; // ✅ Import from context
    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="md:hidden overflow-x-auto">
        <div
          ...
          style={{ width: `${products.length * 180}px` }}
        >
          {products.map((product) => (
...
function ProductCard({
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-100 p-3 md:p-4 relative hover:shadow-md transition-shadow duration-200">
      {/* Wishlist Button */}
      <button
